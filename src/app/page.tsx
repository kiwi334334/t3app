...
export default function HomePage() {
  const { cart, cost, allamounts } = useSharedFormState();
  return (
    <div className="w-screen h-screen">
      ...
      <div className="fixed right-[30%] h-full w-[40%] overflow-scroll">
        <div className="overflow-scroll h-full w-full bg-stone-300 scrollbar-hide p-10">
          <h1>COUCHES</h1>
          <Iteminstore type={"Couch"} title={"NIKEA Auto Fold"} price={400} imgURL={"https://d2xcq4qphg1ge9.cloudfront.net/assets/130047/3795631/original_sofa_1000px.png"} /><br />
